...
namespace Exercise.DataAccess.DataBase
{
    public partial class AtlasExercisesContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-B5D1Q8K;Initial Catalog=AtlasExercises;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movement>(entity =>
            {
                ...
                entity.HasOne(d => d.IdDifficultyNavigation)
                    .WithMany(p => p.Movements)
                    .HasForeignKey(d => d.IdDifficulty)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Movement_Difficulty");
